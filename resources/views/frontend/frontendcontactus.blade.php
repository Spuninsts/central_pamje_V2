            ...
            <div class="container">
                <div class="row my-2">
                    ...
                    <div class="cen-contact-form">
                        ...
                        <div class="row  my-4">
                            <div class="col-sm-8 ">
                                <form id="contact-form" method="POST" action="{{ route('email.contact') }}" role="form" class="php-email-form">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group mt-3 mt-md-0">
                                            <input type="email" class="form-control cen-bg-darkgrey" name="from_email" id="email" placeholder="Your Email" required="">
                                        </div>
                                    </div>
