          ...
          <div class="row py-3 d-flex flex-column flex-sm-row">
            ...
            <div class="col-sm-12 col-md-4 col-lg-6 mt-2  ">
              <ul class="list-unstyled d-flex justify-content-center">
                ...
                <li class="ms-3"><a href="https://www.facebook.com/PAMJE2011"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFFFFF" class="bi bi-facebook" viewBox="0 0 16 16">
