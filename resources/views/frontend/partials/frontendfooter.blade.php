<div class="container-fluid cen-bg-darkblue  ">
          ...
          <footer class="row cols-1 w-100">
            ...
            <div class="col my-4 ">
              ...
              <ul class="nav flex-column">
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">PAMJE</a></li>
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-between   border-top">
          ...
          <div class="mt-2">
            <ul class="list-unstyled d-flex">
              <li class="ms-3"><a href="#"><img src="{{ asset('frontend/img/icon-yt.svg') }}" alt="Youtube" height="20" width="20"></a></li>
              <li class="ms-3"><a href="#"><img src="{{ asset('frontend/img/icon-fb.svg') }}" alt="Facebook" height="20" width="20"></a></li>
              <li class="ms-3"><a href="#"><img src="{{ asset('frontend/img/icon-ig.svg') }}" alt="Instagram" height="20" width="20"></a></li>
            </ul>
          </div>
      ...
      <!-- Vendor JS Files -->
    <script src="{ asset('frontend/js/purecounter/purecounter_vanilla.js') }}"></script>
