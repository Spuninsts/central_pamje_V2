            ...
            <div class="row d-flex justify-content-center py-5">
              ...
              <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center mb-3">
                <div class="cen-counts">
                  ...
                  <span data-purecounter-start="0" data-purecounter-end="{{$assetCount[0]}}" data-purecounter-duration="1" class="purecounter"></span>
              ...
              <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center mb-3">
                <div class="cen-counts">
                  ...
                  <span data-purecounter-start="0" data-purecounter-end="{{$assetCount[1]}}" data-purecounter-duration="1" class="purecounter"></span>
              ...
              <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center mb-3">
                <div class="cen-counts">
                  ...
                  <span data-purecounter-start="0" data-purecounter-end="{{$assetCount[2]}}" data-purecounter-duration="1" class="purecounter"></span>
                  <p class="text-white">Peer Reviewers</p>
                </div>
              </div>
