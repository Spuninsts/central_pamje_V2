...
<html lang="en">
    ...
    <div class="container-fluid">
      ...
      <div class="row my-3">
        <span><a href="/" class="cen-breadcrumbs"> Home</a>&nbsp;»
                <a href="/aboutus" class="cen-breadcrumbs">Sponsor</a>&nbsp;»&nbsp;
    ...
    <div class="container-fluid">
      <div class="container">
        <div class="row my-5">
            <h2>Centralized Electronic Roster of Philippine Medical Journals (CENTRAL)</h2>
        </div>

        <div class="cen-about">
              <div class="row">
                    <h5 class="text-danger fw-bold">Introduction</h5>
              </div>
          ...
          <div class="cen-about">
              <div class="row">
                  <h5 class="text-danger fw-bold">Our Mission</h5>
              </div>
          ...
          <div class="cen-about">
              <div class="row">
                  <h5 class="text-danger fw-bold">Services for Partner Journals</h5>
              </div>
          ...
          <div class="cen-about">
              <div class="row">
                  <h5 class="text-danger fw-bold">Join our community in advancing Philippine medical excellence</h5>
              </div>

              <div class="row my-2">
                  <p>•	Researchers: Find the latest research to inform your work and advance medical knowledge in the Philippines.</p>
                  <p>•	Policymakers: Access evidence-based data to guide healthcare policy and improve public health outcomes.</p>
                  <p>•	Authors: Share your research with a wider audience and contribute to the advancement of Philippine medicine.</p>
                  <p></p>
              </div>
