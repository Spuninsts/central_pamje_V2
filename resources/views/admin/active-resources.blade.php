        ...
        <div class="page-content">
            ...
            <nav class="page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Active Resources</li>
                </ol>
            </nav>
            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <div class="mt-3">
                                <a href="{{ route('admin.new-page') }}" class="btn btn-info active" role="button" aria-pressed="true">Add Resource</a>
                            </div>
                        </div>
                    </div>
                </div>
