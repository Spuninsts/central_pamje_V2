		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<nav class="page-breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Active Banners</li>
					</ol>
				</nav>
				...
				<div class="row">
					...
					<div class="card">
						<div class="card-body">
							<div class="mt-3">
							<a href="{{ route('admin.new-banner') }}" class="btn btn-info active" role="button" aria-pressed="true">Add Banner</a>
							</div>
						</div>
					</div>
					</div>
