                ...
                <div class="top-inner clearfix">
                    <div class="left-column pull-left">
                        <ul class="info clearfix">
                            <li><i class="far fa-map-marker-alt"></i>Philippine Nurses Association Bldg. Malate, Manila, NCR, Philippines</li>
...
<div class="main-box">
<div class="logo-box">
    <figure class="logo"><a href="{{ route('dashboard') }}"><img src="{{ asset('frontend/assets/images/pamje_logo.png') }}" alt=""></a></figure>
</div>
            ...
            <ul class="navigation clearfix">
                <li class="current dropdown"><a href="index.html"><span>Home</span></a>
                    <ul>
                        ...
                        <li><a href="index-2.html">Editorial Team</a></li>
                ...
                <li class="dropdown"><a href="index.html"><span>Instructions</span></a>
                    <ul>
                ...
                <li class="dropdown"><a href="index.html"><span>Journals</span></a>
                    <ul>
                ...
                <li class="dropdown"><a href="index.html"><span>About us</span></a>
                    <ul>
                        <li><a href="blog-1.html">Blog 01</a></li>
                        <li><a href="blog-2.html">Blog 02</a></li>
                        <li><a href="blog-3.html">Blog 03</a></li>
...
<div class="btn-box">
    <a href="index.html" class="theme-btn btn-one"><span>+</span>Register</a>
</div>
</div>
</div>
</div>
