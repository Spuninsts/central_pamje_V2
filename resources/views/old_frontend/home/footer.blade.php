                            ...
                            <div class="footer-widget contact-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="info-list clearfix">
                                        <li><i class="fas fa-map-marker-alt"></i>Philippine Nurses Association Bldg. 1663 F.T. Benitez St. Malate, Manila, NCR, Philippines</li>
                                        <li><i class="fas fa-microphone"></i><a href="tel:23055873407">+63xxxxxxxxxxx</a></li>
                                        <li><i class="fas fa-envelope"></i><a href="mailto:info@example.com">conact@example.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="footer-bottom">
                <div class="auto-container">
                    <div class="inner-box clearfix">
                        <figure class="footer-logo"><a href="index.html"><img src="{{ asset('frontend/assets/images/footer_pamje.png') }}" alt=""></a></figure>
                        <div class="copyright pull-left">
                            <p><a href="index.html">Pamje.org</a> &copy; 2024 All Right Reserved</p>
                        </div>
